...
Database.items = {
    "hero_card_piece_2":{name:"绿色勇者卡碎片", piece:10, },
    "hero_card_piece_3":{name:"蓝色勇者卡碎片", piece:10, },
    "hero_card_piece_4":{name:"紫色勇者卡碎片", piece:10, },
    "hero_card_piece_5":{name:"橙色勇者卡碎片", piece:30, },
    "hero_card_piece_6":{name:"红色勇者卡碎片", piece:50, },
    "hero_card_piece_7":{name:"金色勇者卡碎片", piece:100, },
    "hero_piece_8":{name:"暗金勇者卡碎片", piece:100, },
    "hero_1":{name:"未知勇者卡", },
    "hero_2":{name:"绿色勇者卡", },
    "hero_3":{name:"蓝色勇者卡", },
    "hero_4":{name:"紫色勇者卡", },
    ...
    "hero_card_random_2":{name:"绿色随机勇者卡", use:true, },
    "hero_card_random_3":{name:"蓝色随机勇者卡", use:true, },
    "hero_card_random_4":{name:"紫色随机勇者卡", use:true, },
    "hero_card_random_5":{name:"橙色随机勇者卡", use:true, },
    "hero_card_random_6":{name:"红色随机勇者卡", use:true, },
    "hero_card_random_7":{name:"金色随机勇者卡", use:true, },
    "hero_card_random_8":{name:"暗金随机勇者卡", use:true, },
    "hero_card_random_piece_2":{name:"绿色随机勇者卡碎片", piece:10, },
    "hero_card_random_piece_3":{name:"蓝色随机勇者卡碎片", piece:10, },
    "hero_card_random_piece_4":{name:"紫色随机勇者卡碎片", piece:10, },
    "hero_card_random_piece_5":{name:"橙色随机勇者卡碎片", piece:30, },
    "hero_card_random_piece_6":{name:"红色随机勇者卡碎片", piece:50, },
    "hero_card_random_piece_7":{name:"金色随机勇者卡碎片", piece:100, },
    "hero_card_random_piece_8":{name:"暗金随机勇者卡碎片", piece:100, },
    ...
    "star_stone":{name:"星石"},
    "wow_rune_accelerate":{name:"符文加速券"},
    "enchant_stone":{name:"附魔石"},
    "clover":{name:"三叶草"},
...
Database.heros = {
    ...
    "80011":{name:"上杉谦信", cls:"X", level:10},
    "80012":{name:"瓦尔基里", cls:"X", level:10},
    "80013":{name:"武田信玄", cls:"X", level:10},
    "80014":{name:"朱雀", cls:"X", level:10},
    "80015":{name:"伊邪那美", cls:"X", level:10},
    "80016":{name:"伊邪那岐", cls:"X", level:10},
    "80017":{name:"句芒", cls:"X", level:10},
    "80018":{name:"犬神", cls:"X", level:10},
    "80019":{name:"毗湿摩", cls:"X", level:10},
    "80025":{name:"旱神女魅", cls:"X", level:10},
    "80026":{name:"雷震子", cls:"X", level:10},
    "80030":{name:"瑶姬", cls:"X", level:10},
    "80031":{name:"睡眠之神", cls:"X", level:10},
    "80032":{name:"勇者一代目", cls:"X", level:10},
    "80033":{name:"喵老师", cls:"X", level:10},
    "80034":{name:"阿狸", cls:"X", level:10},
